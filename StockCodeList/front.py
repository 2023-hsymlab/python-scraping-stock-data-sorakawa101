...
# df_stock_code.loc[df_stock_code["市場・商品区分"] == "市場第一部（内国株）", [
#     "コード", "銘柄名", "33業種コード", "33業種区分", "規模コード", "規模区分"]]


# st.line_chart(df_stock_data.loc[:, 'Volume'])
# st.area_chart(df_stock_data.loc[:, ['Open', 'High', 'Low', 'Close']])
# st.bar_chart(df_stock_data)
